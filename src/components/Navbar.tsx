    ...
    <nav className="sticky top-0 z-50 border-b border-white/5 bg-[#060608]/80 backdrop-blur-xl">
      <div className="max-w-7xl mx-auto px-4 h-14 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2 group">
          <span className="text-lg font-black tracking-tight text-white" style={{ fontFamily: "var(--font-dm-sans), 'DM Sans', sans-serif" }}>
            Eve<span className="text-red-500">Army</span>
          </span>
        </Link>

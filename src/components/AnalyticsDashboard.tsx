...
export default function AnalyticsDashboard() {
  ...
  if (loading && viewType === "deployers") {
    return <div className="flex items-center justify-center h-full min-h-[50vh] text-zinc-600 bg-[#060608]">Loading deployers...</div>;
  }

  return (
    <div className="flex flex-col h-full min-h-0 bg-[#060608] text-white overflow-y-auto overflow-x-hidden">
      {/* Controls bar */}

...
/** Shared site footer (matches OpenClaw / analytics / voices footers). */
export default function SiteFooter() {
  return (
    <footer className="shrink-0 py-3 border-t border-white/5 bg-[#060608]">
      <div className="flex items-center justify-center gap-3 text-[10px] text-zinc-700 px-4">
